<head>
    ...
    <title>Membuat Aplikasi Sederhana Menggunakan PHP OOP, Mysql an Bootstraps</title>
        ...
        <div class="card-body">
            <form action="" method="post" id="createProduct">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="<?= $getProduct ['name']; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Price</label>
                    <input type="number" class="form-control" name="price" id="price" value="<?= $getProduct ['price']; ?>" required min="0">
                </div>
            </form>
            <div class="float-end">
